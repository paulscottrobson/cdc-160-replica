...
case 0x40: /** std %d/sta %d **/
   eacd();z = a;write();rni();cycles = cycles + 3;break;
case 0x41: /** sti %i/sta (%d) **/
   eaci();z = a;write();rni();cycles = cycles + 4;break;
case 0x42: /** stf %f/sta %f **/
   eacf();z = a;write();rni();cycles = cycles + 3;break;
case 0x43: /** stb %b/sta %b **/
   eacb();z = a;write();rni();cycles = cycles + 3;break;
